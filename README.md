...
<title>EMIRG AI — Operational Intelligence for Modern Business</title>
<meta name="description" content="EMIRG AI deploys enterprise artificial intelligence to map your operations, integrate your technology, automate demand planning, and build autonomous workflows — measurable ROI in weeks.">
...
<style>
/* ═══════════════════════════════════════════════
   EMIRG AI — Industrial Blueprint Design System
   Fonts: Bebas Neue (display) · Bricolage Grotesque (body) · IBM Plex Mono (code)
   Palette: Deep slate · Electric amber · Ice white · Blueprint cyan
═══════════════════════════════════════════════ */
:root {
  /* Core Palette */
  --void:      #06080a;
...
.sb::before{content:'→';color:var(--amber);flex-shrink:0;margin-top:1px;}
...
<nav class="mob-nav" id="mob-nav">
  ...
  <button class="nav-pill" onclick="openModal('consult');closeMob()">Book Free Discovery Call →</button>
</nav>
...
<header class="nav" id="nav">
  ...
  <div class="nav-right">
    <button class="nav-pill" onclick="openModal('consult')">Book Discovery Call →</button>
...
<section id="s-hero">
  ...
  <div class="hero-wrap">
    <!-- LEFT -->
    <div>
      <div class="hero-eyebrow"><div class="eyebrow-line"></div>AI Consultancy · Canada · Est. 2024</div>
      <h1 class="hero-h1">
        <span class="hi">INTELLIGENT</span>
        <span class="hd">OPERATIONS</span>
        <span class="hc">DELIVERED.</span>
      </h1>
      <p class="hero-p">EMIRG AI deploys <strong>enterprise-grade artificial intelligence</strong> to map your operations, integrate your tech stack, automate demand planning, and build autonomous workflows — delivering measurable ROI within weeks, not quarters.</p>
      <div class="hero-btns">
        <button class="btn-amber" onclick="openModal('consult')">📞 Book Free Discovery Call</button>
        <button class="btn-ghost" onclick="scrollTo('s-roi')">Calculate My ROI →</button>
      </div>
      <div class="hero-kpis">
      ...
      <div class="hero-terminal">
        ...
        <div class="term-body">
          ...
          <div id="t-scan" class="tab-pane active">
            ...
            <div class="tl"><span class="tc-ok">✓</span> <span style="color:var(--body);">Connecting to data sources...</span> <span class="tc-ok">done</span></div>
            <div class="tl"><span class="tc-ok">✓</span> <span style="color:var(--body);">Process nodes discovered: </span><span class="tc-warn">147</span></div>
            <div class="tl"><span class="tc-ok">✓</span> <span style="color:var(--body);">Bottlenecks identified: </span><span class="tc-err">23</span></div>
            <div class="tl"><span class="tc-ok">✓</span> <span style="color:var(--body);">Automation candidates: </span><span class="tc-info">31</span></div>
            <div class="tl"><span class="tc-ok">✓</span> <span style="color:var(--body);">Est. annual savings: </span><span class="tc-ok">$284,000 CAD</span></div>
          ...
          <div id="t-map" class="tab-pane">
            ...
            <div class="tl"><span class="tc-ok">✓</span> <span style="color:var(--body);">Mapping 147 nodes across 8 departments</span></div>
            <div class="tl"><span class="tc-ok">✓</span> <span style="color:var(--body);">Dependencies linked: </span><span class="tc-info">342</span></div>
            <div class="tl"><span class="tc-ok">✓</span> <span style="color:var(--body);">Critical path: </span><span class="tc-warn">Sales → Finance → Ops</span></div>
            <div class="tl"><span class="tc-ok">✓</span> <span style="color:var(--body);">Report generated: </span><span class="tc-ok">ops-map-v1.pdf</span></div>
            <div class="tl"><span class="tc-prompt">$</span> <span class="tc-cursor"></span></div>
          </div>
          <div id="t-auto" class="tab-pane">
            <div class="tl"><span class="tc-prompt">$</span> emirg automate --deploy --priority high</div>
            <div class="tl"><span class="tc-ok">✓</span> <span style="color:var(--body);">Invoice processing: </span><span class="tc-ok">automated → 98% accuracy</span></div>
            <div class="tl"><span class="tc-ok">✓</span> <span style="color:var(--body);">Demand forecast model: </span><span class="tc-ok">live → 94.2%</span></div>
            <div class="tl"><span class="tc-ok">✓</span> <span style="color:var(--body);">Approval workflows: </span><span class="tc-ok">4 automated</span></div>
            <div class="tl"><span class="tc-ok">✓</span> <span style="color:var(--body);">Time saved/week: </span><span class="tc-warn">45 hours</span></div>
            <div class="tl"><span class="tc-prompt">$</span> <span class="tc-cursor"></span></div>
          </div>
        </div>
...
<div class="ticker-wrap">
  <div class="ticker-inner">
    <div class="tk">Operational Mapping <span class="tkv">✦ AI-Native</span></div>
    <div class="tk">Technology Integration <span class="tkv">✦ Zero Downtime</span></div>
    <div class="tk">Autonomous Workflows <span class="tkv">✦ 24/7 Active</span></div>
    <div class="tk">Demand Forecasting <span class="tkv">✦ 94% Accuracy</span></div>
    <div class="tk">Avg. ROI Horizon <span class="tkv">✦ 60 Days</span></div>
    <div class="tk">PIPEDA Compliant <span class="tkv">✦ SOC2 Aligned</span></div>
    <div class="tk">Powered by Claude <span class="tkv">✦ Anthropic</span></div>
    <div class="tk">Brant, Ontario <span class="tkv">✦ Serving Canada</span></div>
    <div class="tk">Operational Mapping <span class="tkv">✦ AI-Native</span></div>
    <div class="tk">Technology Integration <span class="tkv">✦ Zero Downtime</span></div>
    <div class="tk">Autonomous Workflows <span class="tkv">✦ 24/7 Active</span></div>
    <div class="tk">Demand Forecasting <span class="tkv">✦ 94% Accuracy</span></div>
    ...
    <div class="wrap">
      <div class="split top" style="gap:80px;">
        ...
        <div>
          ...
          <p class="body-l reveal d2" style="margin-bottom:30px;">Most Canadian businesses run on undocumented processes, tribal knowledge, and disconnected tools. Nobody has ever seen the full operational picture — which means nobody knows where the inefficiency lives.</p>
            ...
            <div class="card" style="padding:18px 20px;">
              <div style="display:flex;gap:14px;align-items:flex-start;">
                ...
                <div>
                  ...
                  <div style="font-size:13px;color:var(--muted);line-height:1.7;">Teams unknowingly repeat tasks, re-enter data across 4–6 platforms, and rebuild reports that already exist.</div>
                </div>
              </div>
            </div>
            <div class="card" style="padding:18px 20px;">
              <div style="display:flex;gap:14px;align-items:flex-start;">
                ...
                <div>
                  ...
                  <div style="font-size:13px;color:var(--muted);line-height:1.7;">Critical intelligence trapped in spreadsheets, inboxes, and individual people's heads — invisible when needed most.</div>
                </div>
              </div>
            </div>
            <div class="card" style="padding:18px 20px;">
              <div style="display:flex;gap:14px;align-items:flex-start;">
                ...
                <div>
                  ...
                  <div style="font-size:13px;color:var(--muted);line-height:1.7;">Leaders lack real-time visibility, so decisions wait or get made on incomplete information — costing millions.</div>
                </div>
              </div>
            </div>
          </div>
          <button class="btn-amber reveal d4" onclick="openModal('audit')">Get a Free Operations Audit →</button>
        </div>
        <!-- RIGHT -->
        <div class="col" style="gap:12px;">
          <div class="g2 reveal" style="gap:10px;">
            ...
            <div style="background:var(--cyanglow);border:1px solid var(--cyanedge);border-radius:var(--r2);padding:20px;text-align:center;">
              <div style="font-family:var(--display);font-size:52px;letter-spacing:-2px;color:var(--cyan);line-height:1;margin-bottom:6px;">3.5×</div>
          ...
          <div style="background:var(--amberglow);border:1px solid var(--amberedge);border-radius:var(--r2);padding:22px;text-align:center;" class="reveal d1">
            <div style="font-family:var(--mono);font-size:9px;letter-spacing:2px;text-transform:uppercase;color:var(--amber);margin-bottom:10px;opacity:.75;">Estimated Monthly Waste — 25-Person Canadian Business</div>
          ...
          <div class="hero-terminal reveal d2" style="border-radius:var(--r);">
            ...
            <div style="padding:14px 16px;">
              ...
              <div class="tl"><span class="tc-ok">✓</span> <span style="color:var(--body);">Revenue leakage detected: </span><span class="tc-err">$47,200/mo</span></div>
              <div class="tl"><span class="tc-ok">✓</span> <span style="color:var(--body);">Root cause: </span><span class="tc-warn">3 unmapped approval loops</span></div>
              <div class="tl"><span class="tc-ok">✓</span> <span style="color:var(--body);">Fix available: </span><span class="tc-info">automation + restructure</span></div>
              <div class="tl"><span class="tc-ok">✓</span> <span style="color:var(--body);">Time to implement: </span><span class="tc-ok">~14 days</span></div>
              <div class="tl"><span class="tc-prompt">$</span> <span class="tc-cursor"></span></div>
            </div>
          </div>
        </div>
...
<div class="metrics-band">
  <div class="metrics-inner">
    <div class="metric reveal">
      ...
      <div class="metric-src">Avg. of completed engagements · EMIRG AI · 2024–2025</div>
    </div>
    ...
    <div class="metric reveal d3">
      <div class="metric-n" style="color:var(--amber2);">−68%</div>
...
<section id="s-services">
  <div class="sec">
    <div class="wrap" style="margin-bottom:56px;text-align:center;">
      ...
      <p class="body-l reveal d2" style="max-width:580px;margin:0 auto;">We don't sell software subscriptions. We deliver working systems that permanently change how your business operates — with measurable proof.</p>
    </div>
    <div class="wrap">
      <div class="svc-mega reveal">
        <div class="svc-cell">
          <div class="svc-cell-num">01</div>
          <div class="svc-cell-icon">🗺️</div>
          <div class="svc-cell-title">OPERATIONAL<br>MAPPING</div>
          <p class="svc-cell-body">We deploy Claude AI to map every process, workflow, decision point, and dependency in your business — many for the first time. The deliverable is a living Operations Map that becomes your operational source of truth, updated continuously.</p>
        ...
        <div class="svc-cell">
          ...
          <div class="svc-cell-icon">🔗</div>
          <div class="svc-cell-title">TECHNOLOGY<br>INTEGRATION</div>
          <p class="svc-cell-body">Fragmented tools cost more than their licenses — they cost productivity and sanity. We audit your tech stack, eliminate redundancy, and build integrations that make every system work as one coherent intelligence layer.</p>
          <div class="svc-bullets">
        ...
        <div class="svc-cell">
          ...
          <p class="svc-cell-body">Turn your highest-cost manual processes into intelligent automated workflows. Using Make, n8n, and custom AI agents, we build systems that run 24/7 without human oversight — freeing your team for genuinely high-value work.</p>
          <div class="svc-bullets">
        ...
        <div class="svc-cell">
          ...
          <p class="svc-cell-body">Replace gut-feel with machine precision. Our AI demand planning models ingest your historical data, market signals, and operational context to generate forecasts your supply chain can actually rely on — live, adaptive, explainable.</p>
          <div class="svc-bullets">
    ...
    <div class="wrap" style="margin-top:72px;">
      <div class="split top" style="gap:72px;">
        <div>
          ...
          <p class="body-l reveal d2" style="margin-bottom:28px;">Every EMIRG AI engagement is powered by <strong>Anthropic's Claude</strong> — the most capable and safety-aligned reasoning model in production today. We combine it with a purpose-built automation and analytics infrastructure.</p>
          ...
          <button class="btn-amber reveal d4" onclick="openModal('consult')" style="font-size:13px;padding:12px 24px;">Start With a Discovery Call →</button>
        </div>
        <div class="reveal d1">
          ...
          <div class="tbl-wrap reveal d2">
            <table class="comp">
              ...
              <tbody>
                <tr><td class="td-key">Time to Map</td><td class="td-win">✦ 2–3 wks</td><td class="td-mid">3–6 mo</td><td class="td-bad">6–12 mo</td></tr>
                <tr><td class="td-key">AI-Native</td><td class="td-win">✦ Core method</td><td class="td-mid">Add-on</td><td class="td-bad">Rarely</td></tr>
                <tr><td class="td-key">Implementation</td><td class="td-win">✦ Included</td><td class="td-bad">Extra cost</td><td class="td-mid">Slow</td></tr>
                <tr><td class="td-key">First Value</td><td class="td-win">✦ Week 1</td><td class="td-mid">Month 3</td><td class="td-bad">Month 6+</td></tr>
                <tr><td class="td-key">Canadian Context</td><td class="td-win">✦ Native</td><td class="td-mid">Generic</td><td class="td-win">Yes</td></tr>
              </tbody>
            </table>
          </div>
        </div>
    ...
    <div class="wrap">
      <div class="split top" style="gap:80px;">
        ...
        <div>
          ...
          <p class="body-l reveal d2" style="margin-bottom:36px;">We establish a quantitative baseline before every engagement and measure against it throughout. These are reported numbers from completed work — not projections from a pitch deck.</p>
          <div class="col reveal d3" id="hbars" style="gap:13px;">
            ...
            <div class="hbar-row"><div class="hbar-label">Manual Task Time</div><div class="hbar-track"><div class="hbar-fill" data-w="62%" style="background:var(--amber2);"></div></div><div class="hbar-val">−31%</div></div>
            <div class="hbar-row"><div class="hbar-label">Decision Speed</div><div class="hbar-track"><div class="hbar-fill" data-w="84%" style="background:var(--cyan);"></div></div><div class="hbar-val">4.2×</div></div>
            <div class="hbar-row"><div class="hbar-label">Error Rate</div><div class="hbar-track"><div class="hbar-fill" data-w="68%" style="background:var(--red);"></div></div><div class="hbar-val">−68%</div></div>
            <div class="hbar-row"><div class="hbar-label">Reporting Time</div><div class="hbar-track"><div class="hbar-fill" data-w="81%" style="background:var(--amber);"></div></div><div class="hbar-val">−81%</div></div>
          </div>
        </div>
        <!-- RIGHT testimonials -->
        <div class="col" style="gap:18px;">
          ...
          <div class="tcard reveal d1">
            <div class="tcard-q">"</div>
            <div class="tcard-text">"We'd been doing three things wrong for seven years — not because we were careless, but because no human had ever seen the full operational picture at once. The AI did it in 48 hours."</div>
            <div class="tcard-line"></div>
            <div class="tcard-name">VP Operations</div>
            <div class="tcard-role">E-Commerce Retailer · Ontario · 2025</div>
          </div>
    ...
    <div class="wrap">
      <div class="split top" style="gap:80px;">
        <div>
          ...
          <p class="body-l reveal d2" style="margin-bottom:32px;">The EMIRG AI method is a repeatable, AI-native engagement framework that delivers a full operational transformation — with your first deliverable in Week 1, not Month 3.</p>
          <div class="col reveal d3" style="gap:12px;margin-bottom:36px;">
            <div class="card" style="padding:18px 22px;border-color:var(--amberedge);">
              ...
              <div class="col" style="gap:7px;">
                <div style="font-size:13px;color:var(--dim);display:flex;gap:8px;align-items:center;"><span style="color:var(--emerald);">✓</span> Full Operations Map — visualised &amp; interactive</div>
                <div style="font-size:13px;color:var(--dim);display:flex;gap:8px;align-items:center;"><span style="color:var(--emerald);">✓</span> ROI-prioritised improvement roadmap</div>
                <div style="font-size:13px;color:var(--dim);display:flex;gap:8px;align-items:center;"><span style="color:var(--emerald);">✓</span> Financial model with payback projections</div>
                <div style="font-size:13px;color:var(--dim);display:flex;gap:8px;align-items:center;"><span style="color:var(--emerald);">✓</span> 90-day implementation support included</div>
                <div style="font-size:13px;color:var(--dim);display:flex;gap:8px;align-items:center;"><span style="color:var(--emerald);">✓</span> Staff training on all deployed systems</div>
              </div>
            </div>
          </div>
          <div class="rw reveal d4">
            <button class="btn-amber" onclick="openModal('consult')">Book Discovery Call →</button>
          ...
          <div class="proc-item open">
            ...
            <div class="proc-body" id="pb1">
              <div class="proc-inner">
                <div class="proc-text">Deep-dive stakeholder interviews, full systems audit, and data collection. Our AI begins ingesting your business context from day one — building a baseline against which all improvements will be measured.</div>
                <div class="proc-tags"><span class="pill pill-d">Week 1–2</span><span class="pill pill-a">First deliverable: Day 7</span></div>
              </div>
            </div>
          </div>
          <div class="proc-item">
            ...
            <div class="proc-body" id="pb2">
              <div class="proc-inner">
                <div class="proc-text">Claude analyses every workflow, identifies dependencies, bottlenecks, and hidden costs — generating your full Operations Map with automated recommendations prioritised by ROI impact and implementation ease.</div>
                <div class="proc-tags"><span class="pill pill-d">Day 10–14</span><span class="pill pill-c">Claude-Powered</span></div>
              </div>
            </div>
          </div>
          <div class="proc-item">
            ...
            <div class="proc-body" id="pb3">
              <div class="proc-inner">
                <div class="proc-text">Prioritised roadmap of optimisations with projected ROI, effort estimates, implementation sequences, and quick-win identification. Your board-ready transformation plan — ready to present with confidence.</div>
                <div class="proc-tags"><span class="pill pill-d">Week 2–3</span><span class="pill pill-a">Board-Ready</span></div>
              </div>
            </div>
          </div>
          <div class="proc-item">
            ...
            <div class="proc-body" id="pb4">
              <div class="proc-inner">
                <div class="proc-text">We build alongside your team. Automations get deployed. Integrations go live. Dashboards launch. Staff get trained. Real change implemented — not more strategy documents collecting digital dust.</div>
                <div class="proc-tags"><span class="pill pill-d">Week 3–8</span><span class="pill pill-g">Hands-On Build</span></div>
              </div>
            </div>
          </div>
          <div class="proc-item">
    ...
    <div class="wrap">
      <div class="split top" style="gap:72px;">
        <div>
          ...
          <p class="body-l reveal d2" style="margin-bottom:32px;">Before every engagement, we build a projected ROI model and share it with you. Adjust the sliders to estimate what EMIRG AI could deliver for your business — we'll confirm projections in your free discovery call.</p>
          <div class="col reveal d3" style="gap:10px;">
            ...
            <div style="display:grid;grid-template-columns:1fr 1fr;gap:10px;">
              ...
              <div class="card" style="padding:18px;text-align:center;">
                <div style="font-family:var(--display);font-size:32px;letter-spacing:-1px;color:var(--amber);line-height:1;margin-bottom:5px;">−68%</div>
                <div style="font-size:11px;color:var(--muted);">Avg. error reduction</div>
              </div>
            </div>
            <div class="rw">
              <button class="btn-amber" onclick="openModal('consult')" style="flex:1;font-size:13.5px;">Book Discovery Call →</button>
    ...
    <div class="wrap" style="max-width:860px;">
      ...
      <div id="faq-list">
        <div class="faq-item">
          ...
          <div class="faq-ans"><div class="faq-ans-in">Our standard engagement runs 6–10 weeks: 2 weeks for Discovery &amp; AI Mapping, 1 week for the Insight Report, then 3–7 weeks for the Implementation Sprint. You receive your first deliverable in Week 1, and measurable ROI typically appears within 60–90 days. Retained monitoring and quarterly re-mapping are optional.</div></div>
        </div>
        <div class="faq-item">
          <button class="faq-btn" onclick="toggleFaq(this)">
          ...
          <div class="faq-ans"><div class="faq-ans-in">No. We handle all technical architecture, integration, and deployment. Your team participates in stakeholder interviews and provides system access — that's it. We train your staff on all new systems we deploy, and all deliverables are designed for non-technical leaders to act on immediately without translation.</div></div>
        </div>
        <div class="faq-item">
          <button class="faq-btn" onclick="toggleFaq(this)">
        ...
        <div class="faq-item">
          ...
          <div class="faq-ans"><div class="faq-ans-in">Traditional consultants spend months interviewing people, produce a strategy report, and leave you to implement it alone — by which point the problem has evolved. We use AI to analyse your operations at a depth and speed no human team can match, and we stay through implementation. When our engagement ends, something has measurably changed — not just been documented.</div></div>
        </div>
        <div class="faq-item">
          <button class="faq-btn" onclick="toggleFaq(this)">
        ...
        <div class="faq-item">
          ...
          <div class="faq-ans"><div class="faq-ans-in">We ingest 12–36 months of your historical sales, operational, and supply chain data. Our AI identifies seasonality, trend drivers, market signals, and demand patterns that conventional forecasting misses. The output is a live forecasting dashboard with weekly AI-generated alerts — updated automatically as new data flows in. Current portfolio accuracy: 94.2%.</div></div>
        </div>
      </div>
    </div>
  </div>
...
<div class="cta-band">
  ...
  <div style="position:relative;z-index:1;max-width:740px;margin:0 auto;">
    ...
    <p class="body-l reveal d2" style="margin-bottom:40px;max-width:520px;margin-left:auto;margin-right:auto;text-align:center;">Book a free 45-minute Discovery Call. We'll map one of your core processes live, identify your three biggest inefficiencies, and give you a projected ROI — zero cost, zero obligation.</p>
    <div class="rw reveal d3" style="justify-content:center;gap:14px;margin-bottom:52px;">
      <button class="btn-amber" onclick="openModal('consult')" style="font-size:15px;padding:16px 44px;">📞 Book Free Discovery Call</button>
      <button class="btn-ghost" onclick="openModal('audit')" style="font-size:14px;padding:16px 32px;">📋 Request Process Audit</button>
    </div>
...
<footer class="footer">
  <div class="footer-grid">
    <div>
      ...
      <div class="footer-about">AI-powered operations consulting for Canadian businesses. We map, automate, integrate, and optimise — delivering measurable results in weeks.</div>
    ...
    <div>
      ...
      <div class="fc-links">
        ...
        <div style="margin-top:14px;"><button class="btn-amber" onclick="openModal('consult')" style="width:100%;padding:11px 18px;font-size:13px;">Book a Call →</button></div>
      </div>
    </div>
  </div>
  <div class="footer-bar">
    <div class="footer-copy">© 2026 EMIRG AI Inc. · All rights reserved · Brant, Ontario, Canada</div>
  ...
  <div id="modal-box">
    <div class="modal-top">
      <div class="modal-id">
        ...
        <div>
          ...
          <div class="modal-tsub">EMIRG AI · logistics@emirg-group.com</div>
        </div>
      </div>
    ...
    <div class="modal-scroll">
      ...
      <div id="m-form">
        ...
        <div class="m-note">Sent directly to logistics@emirg-group.com · We respond within 1 business day</div>
      </div>
    </div>
  </div>
</div>
...
const mCfg={
  ...
  audit:{
    ...
    sub:'Submit your details and we\'ll schedule your complimentary operations audit — no pitch, no obligation.',
    ext:true
  }
};
...
function sendForm(){
  ...
  if(!fn||!ln){err.textContent='⚠ Please enter your first and last name.';err.style.display='block';return;}
  ...
  const subj=`${labels[mType]||'INQUIRY'} — ${fn} ${ln}${co?' · '+co:''}`;
  const body=
    `${labels[mType]||'INQUIRY'} — EMIRG AI\n`+
    `${'━'.repeat(52)}\n\n`+
    `Name:      ${fn} ${ln}\n`+
    `Company:   ${co||'N/A'}\n`+
    `Email:     ${em}\n`+
